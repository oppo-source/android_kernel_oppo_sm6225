...
#Le.Li@MULTIMEDIA.AUDIODRIVER.KTV, 2020/03/30, Add for ktv2.0
KBUILD_CFLAGS += -DOPLUS_FEATURE_KTV

#Le.LI@PSW.MM.MULTIMEDIA.AUDIODRIVER.SMARTPA, 2020/11/21, Add aw87xxx music play set boost volume
KBUILD_CFLAGS += -DOPLUS_AUDIO_PA_BOOST_VOLTAGE

#Nan.Zhong@MULTIMEDIA.AUDIODRIVER.FEATURE, 2021/08/27, Add for workaround to fix adsp issue
