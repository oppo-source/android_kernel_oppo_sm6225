...
//Zhaosidong@ODM_WT.MM.AudioDriver.DIO, 2022/3/9, add for dio4480
...
#ifdef OPLUS_ARCH_EXTENDS
/*Yangchao@PSW.MM.AudioDriver.DIO, 2021/07/31, add DIO4480 support*/
...
/*
 * liuhaituo@MULTIMEDIA.AUDIODRIVER.CODEC, 2021/07/19, Optimize the pop sound when the headset plug in
			 ...
			 struct device_node *node)
{
	...
	/*Jianfeng.Qiu@MULTIMEDIA.AUDIODRIVER.HEADSETDET, 2021/07/20, Delete for fix pop noise at bootup*/
...
#ifdef OPLUS_ARCH_EXTENDS
//AnXinlong@MULTIMEDIA.AUDIODRIVER.DIRVER.2083200, 2021/09/02,
