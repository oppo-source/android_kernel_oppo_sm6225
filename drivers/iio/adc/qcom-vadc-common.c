...
/* Yuzhe.Peng@ODM.BSP.CHARGE 2020/07/26 Add for battery temperture compensation */
extern int ibat_ma_adc_comp;
#endif
...
/* wangxianfei@ODM.BSP.CHARGE 2020/05/26 */
#ifdef OPLUS_FEATURE_CHG_BASIC
/*
 * Voltage to temperature table for 400k pull up for NCPxxXH103xx with
 * 1.875V reference.
 */
static const struct vadc_map_pt adcmap_batt_therm_100k_4250[] = {
	{	1252	,	-400	},
	{	1205	,	-380	},
	{	1158	,	-360	},
	{	1111	,	-340	},
...
/*
 * Voltage to temperature table for 100k pull up for NTCG103JF103FT with
 * 1.875V reference.
 */
static const struct vadc_map_pt adcmap_batt_therm_100k_6115[] = {
{	1236 	,	-400	},
{	1191 	,	-380	},
{	1146 	,	-360	},
{	1100 	,	-340	},
 ...
 * 1.875V reference.
 */
static const struct vadc_map_pt adcmap_batt_therm_30k_4250[] = {
	{	1631	,	-400	},
	{	1607	,	-380	},
	{	1581	,	-360	},
	{	1554	,	-340	},
...
/*
 * Voltage to temperature table for 30k pull up for NTCG103JF103FT with
 *  1.875V reference.
 */
static const struct vadc_map_pt adcmap_batt_therm_30k_6115[] = {
{	1623 	,	-400	},
{	1600 	,	-380	},
{	1575 	,	-360	},
{	1548 	,	-340	},
 ...
 * 1.875V reference.
 */
static const struct vadc_map_pt adcmap_batt_therm_400k_4250[] = {
	{	627 	,	-400	},
	{	582 	,	-380	},
	{	540 	,	-360	},
	{	500 	,	-340	},
...
/*
 * Voltage to temperature table for 400k pull up for NTCG103JF103FT with
 * 1.875V reference.
 */
static const struct vadc_map_pt adcmap_batt_therm_400k_6115[] = {
{	612 	,	-400	},
{	569 	,	-380	},
{	529 	,	-360	},
{	491 	,	-340	},
...
/* wangxianfei@ODM.BSP.CHARGE 2020/05/26 */
#ifdef OPLUS_FEATURE_CHG_BASIC
	{adcmap_batt_therm_30k_4250, ARRAY_SIZE(adcmap_batt_therm_30k_4250)},
	{adcmap_batt_therm_30k_6115, ARRAY_SIZE(adcmap_batt_therm_30k_6115)},
#endif
};
...
/* wangxianfei@ODM.BSP.CHARGE 2020/05/26 */
#ifdef OPLUS_FEATURE_CHG_BASIC
	{adcmap_batt_therm_100k_4250, ARRAY_SIZE(adcmap_batt_therm_100k_4250)},
	{adcmap_batt_therm_100k_6115, ARRAY_SIZE(adcmap_batt_therm_100k_6115)},
#endif
};
...
/* wangxianfei@ODM.BSP.CHARGE 2020/05/26 */
#ifdef OPLUS_FEATURE_CHG_BASIC
	{adcmap_batt_therm_400k_4250, ARRAY_SIZE(adcmap_batt_therm_400k_4250)},
	{adcmap_batt_therm_400k_6115, ARRAY_SIZE(adcmap_batt_therm_400k_6115)},
#endif
};
				...
				u16 adc_code, int *result_mdec)
{
	...
	#ifdef OPLUS_FEATURE_CHG_BASIC
	/* Yuzhe.Peng@ODM.BSP.CHARGE 2020/07/26 Add for battery temperture compensation */
	if (ibat_ma_adc_comp < -6000000 || ibat_ma_adc_comp > 0)
		ibat_ma_adc_comp = 0;
	if (2 == lut_index) {
		gnd_res_mohm = 5; /* Resistance to ground of 4250 project */
	} else if (3 == lut_index) {
		gnd_res_mohm = 8; /* Resistance to ground of 6115 project */
	} else {
		gnd_res_mohm = 0;
	}
	voltage = voltage * 1000 + (ibat_ma_adc_comp * gnd_res_mohm); /* compensation voltage in uv */
	voltage = div64_s64(voltage, 1000);
	#endif
