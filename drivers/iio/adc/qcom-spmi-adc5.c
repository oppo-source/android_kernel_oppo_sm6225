...
/*Wenjie.Zhong@PSW.BSP.MISC 2020/12/14 for ADC Read Voltage*/
...
#ifdef OPLUS_FEATURE_CHG_BASIC
/* linzhenming@BSP.CHG.Basic, 2020/12/04, modify for coco charging */ 
...
/*mapenglong@ODM_HQ.charge 2020/06/19 Read charger temp*/
	[ADC_GPIO2_PU2]	= ADC_CHAN_VOLT("gpio2_pu2", 1,
					SCALE_HW_CALIB_DEFAULT)
#else
	[ADC_GPIO2_PU2]	= ADC_CHAN_TEMP("gpio2_pu2", 1,
