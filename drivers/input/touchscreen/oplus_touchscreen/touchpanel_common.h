...
struct hw_resource {
    ...
    int cs_gpio;                                    /*Cs GPIO*/
	int hw_id1_gpio;                            /*hwid1 GPIO*/
	int hw_id2_gpio;                            /*hwid2 GPIO*/
	...
	struct pinctrl_state    *pin_rst2_high;
	struct pinctrl_state    *pin_rst2_low;
...
int request_real_test_limit(struct touchpanel_data *ts, const struct firmware **fw, char *test_limit_name, struct device *device);
