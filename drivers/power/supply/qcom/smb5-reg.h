...
#define JEITA_EN_AFP_HOT_BIT			BIT(7)
#define JEITA_EN_AFP_COLD_BIT			BIT(6)
...
#ifdef OPLUS_FEATURE_CHG_BASIC /*zhangkun@BSP.CHG.Basic, 2019/04/27 Add for disable JEITA*/
#define DCDC_OTG_CURRENT_LIMIT_1000MA_BIT      BIT(2)
#endif
